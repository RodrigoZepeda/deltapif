...
We can calculate the total potential impact fraction by combining the fractions of the subpopulations
...
which implies that the uncertainty was estimated in the log-scale and hence we
