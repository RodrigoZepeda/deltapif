...
A `pif_class` object containing the estimate for the total fraction or
the ensemble fraction that aggregates several fractions (either
potential impact or population attributable).
