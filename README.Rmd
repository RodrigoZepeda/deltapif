...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/pifes)](https://CRAN.R-project.org/package=deltapif)
...
[![Codecov test coverage](https://codecov.io/gh/RodrigoZepeda/pifes/graph/badge.svg)](https://app.codecov.io/gh/RodrigoZepeda/pifes)
<!-- badges: end -->
...
standard deviation of `beta`. To do so we notice that the variance for
the relative risk is actually for the log of beta. We follow the formula
...
the way to get our relative risk is through the exponential function. Finally
as no uncertainty was given for `p` we set `var_p = 0`. 
